...
export const ReasonPhrases: Record<HttpStatusCode, string> = {
     ...
     */
    [HttpStatusCode.INSUFFICIENT_SPACE_ON_RESOURCE]: "Insufficient Space on Resource",
    /**
     * Official Documentation @ https://tools.ietf.org/html/rfc2518#section-10.6
     *
     ...
     */
    [HttpStatusCode.METHOD_FAILURE]: "Method Failure",
    /**
     ...
     */
    [HttpStatusCode.REQUEST_TOO_LONG]: "Request Entity Too Large",
    /**
