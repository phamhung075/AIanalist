...
import { PaginationOptions, FetchPageResult } from '@/_core/helper/interfaces/FetchPageResult.interface';
...
> {
  ...
  async create(req: Request, res: Response, _next: NextFunction) {
    try {
      ...
      const entity = await this.service.create(inputData as any);
